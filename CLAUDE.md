...
- [ ] **Review gate:** stop here for owner acceptance before Phase 6. Phase 6 scorer + data-driven `vastu_rules.json`, Phase 7 validation/two-way-sync extensions, Phase 8 server-side PNG/PDF + pinned share + DXF/IFC, and Phase 9 hardening remain intentionally unstarted.
