...
- [ ] Phase 4 — API/DB wiring · Phase 5 — 2D SVG editor · Phase 6 — scorer + data-driven `vastu_rules.json` · Phase 7 — two-way sync + 90° rotation · Phase 8 — server-side PNG/PDF + share pinning + DXF/IFC (deps `cairosvg`/`ezdxf`/`ifcopenshell` to be flagged when added) · Phase 9 — hardening
