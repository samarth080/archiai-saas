...
- [ ] **Not done:** Phase 10.2 (non-rectangular plot/room support in the *frontend* — the `codex/phase10-nonrect-frontend` branch name promised this but only delivered one backend polygon bug fix; the actual SVG polygon rendering/vertex editing was never built). Not pushed to `origin` — local merge only, pending owner review.
