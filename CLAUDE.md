...
- [ ] **Review gate:** stop here for owner acceptance before Phase 7. Phase 7 validation/two-way-sync extensions and derived-geometry visual refresh, Phase 8 server-side PNG/PDF + pinned share + DXF/IFC, and Phase 9 hardening remain intentionally unstarted.
