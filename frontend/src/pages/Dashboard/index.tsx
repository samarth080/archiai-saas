    ...
    <div className="flex h-screen bg-surface">
      ...
      <main className="min-w-0 flex-1 overflow-y-auto p-4 sm:p-6">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div className="flex min-w-0 flex-1 max-w-xs items-center gap-2 rounded-xl border border-ink/10 bg-graphite-800/70 px-3 py-2">
        ...
        {/* Hero composer */}
        <div className="mb-8 overflow-hidden rounded-2xl border border-ink/10 bg-gradient-to-br from-graphite-750 via-graphite-800 to-graphite-800 p-6 shadow-sm sm:p-8">
        ...
        {!loading && !error && projects.length === 0 && (
          <div className="flex h-48 items-center justify-center rounded-xl border border-dashed border-ink/15 bg-graphite-800/60 backdrop-blur px-4">
